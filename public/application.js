...
/***/ (function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://calm-basin-94254.herokuapp.com/',
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var onCreateTask = function onCreateTask(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.createTask(data).then(ui.createTaskSuccess).catch(ui.createTaskError);
	};

	var onGetUserTasks = function onGetUserTasks(event) {
	  event.preventDefault();
	  api.getUserTasks().then(ui.getUserTasksSuccess).catch(ui.getUserTasksFailure);
	};
	...
	var onDeleteTask = function onDeleteTask(event) {
	  ...
	  ui.refreshTable();
	  api.deleteTask(taskId).then(ui.deleteTaskSuccess).catch(ui.deleteTaskFailure);
	};
	...
	var onUpdateTask = function onUpdateTask(event) {
	  ...
	  var data = getFormFields(event.target);
	  ui.refreshTable();
	  api.updateTask(taskId, data).then(ui.updateTaskSuccess).catch(ui.updateTaskFailure);
	};
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var updateTask = function updateTask(taskId, data) {
	  return $.ajax({
	...
	var getUserTasks = function getUserTasks(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/tasks/',
	    method: 'GET',
	    headers: {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(11);
	var api = __webpack_require__(10);
	var showTasksHB = __webpack_require__(13);
	...
	var refreshTable = function refreshTable() {
	  var showTaskHtml = showTasksHB({ tasks: store.userTasks });
	  $('#content').empty();
	...
	var createTaskError = function createTaskError(data) {
	  userMessage('Something went wrong, please try again.');
	};

	var updateTaskSuccess = function updateTaskSuccess(taskId) {
	  store.userTasks = taskId.tasks;
	  refreshTable();
	  api.getUserTasks().then(getUserTasksSuccess).catch(getUserTasksFailure);
	};
	...
	var getUserTasksSuccess = function getUserTasksSuccess(data) {
	...
	var getUserTasksFailure = function getUserTasksFailure(taskId) {
	  userMessage('Something went wrong, please try again.');
	  store.userTasks = taskId.tasks;
	};

	var deleteTaskSuccess = function deleteTaskSuccess() {
	  refreshTable();
	  api.getUserTasks().then(getUserTasksSuccess).catch(getUserTasksFailure);
	};
	...
	module.exports = {
	  ...
	  getUserTasksFailure: getUserTasksFailure,
	  getUserTasksSuccess: getUserTasksSuccess,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "      <tr>\n        <td>"
	    ...
	    + "</td>\n        <td><button taskId=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"click\" class=\"btn btn-danger delete-task-button\">Delete</button></td>\n        <td><form class=\"update-task-by-id-form\" taskId=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n            <input type=\"text\" id=\"update-task-by-id-button\" name=\"task[description]\">\n            <input type=\"hidden\" name=\"id\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n        <button taskId=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" task=\"text\" class=\"btn btn-info update-task-button\">Edit</button>\n      </form>\n      </tr>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return "<table id=\"user-tasks-table\" class=\"table table-striped signed-in-view\">\n\n  <thead>\n    <tr>\n      <th>Task #</th>\n      <th>Description</th>\n    </tr>\n  </thead>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.tasks : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "</table>\n";
